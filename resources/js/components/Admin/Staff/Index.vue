                    ...
                    <table class="table table-centered table-nowrap">
                        ...
                        <tbody>
                            <tr v-for="user in users" v-bind:key="user.id">
                                ...
                                <td>
                                    <h5 class="font-size-14 mb-1 text-dark">{{user.lastname}}, {{user.firstname}} {{user.middlename}}.</h5>
                                    <p class="text-muted mb-0">{{user.email}}</p>
                                </td>
                                <td class="text-center">
                                    <h5 v-if="user.type == 'Consortium'" class="font-size-12 mb-1 text-dark">{{ user.consortium.acronym }}</h5>
